...
const CFOP_TO_MAP = {
    ...
    'D': 'd', "D'": 'D', 'Dw': 'dw', "Dw'": 'Dw', 'd': 'dw', "d'": 'Dw',
    'L': 'l', "L'": 'L', 'Lw': 'lw', "Lw'": 'Lw', 'l': 'lw', "l'": 'Lw',
    'R': 'r', "R'": 'R', 'Rw': 'rw', "Rw'": 'Rw', 'r': 'rw', "r'": 'Rw',
    'F': 'f', "F'": 'F', 'Fw': 'fw', "Fw'": 'Fw', 'f': 'fw', "f'": 'Fw',
    'B': 'b', "B'": 'B', 'Bw': 'bw', "Bw'": 'Bw', 'b': 'bw', "b'": 'Bw',
    'M': 'm', "M'": 'M', 'E': 'e', "E'": 'E', 'S': 's', "S'": 'S',
